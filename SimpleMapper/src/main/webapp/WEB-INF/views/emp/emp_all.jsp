    ...
    <form id="listForm" name="listForm" method="get">
        ...
        <table class="w-[100%] border border-gray-200">
            ...
            <tr>
                ...
                <th scope="col" class="px-4 py-2 border-b">salary</th>
                <th scope="col" class="px-4 py-2 border-b">commission</th>
            ...
            <c:forEach var="data" items="${emps}">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border-b"><c:out value="${data.ename}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.job}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.manager}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.hiredate}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.salary}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.commission}"></c:out></td>
                    <td class="px-4 py-2 border-b"><c:out value="${data.dno}"></c:out></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
